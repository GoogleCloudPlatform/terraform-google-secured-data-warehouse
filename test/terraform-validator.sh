...
for f in ${policy_file_path}/policies/constraints/*.yaml ; do
    ...
    sed -e "s/CONFIDENTIAL_PROJECT_ID_1/${confidential_project_id_1}/" -e "s/CONFIDENTIAL_PROJECT_ID_2/${datalake_project_id_2}/" -e "s/CONFIDENTIAL_PROJECT_ID_3/${datalake_project_id_3}/" "${f}" > ${f}
done
