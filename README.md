...
| bucket\_logging\_prefix | The preflix name of the bucket that will store the logs. | `string` | `"bkt-dwh-logging"` | no |
...
| enable\_centralized\_logging | If true a centralized logging infrastructure will be created. Set to false if you have a centralized logging in place. | `bool` | `true` | no |
...
| sink\_projects\_logging | The list of the project that the sink were created. |
