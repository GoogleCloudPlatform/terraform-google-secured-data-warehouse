...
The integration tests are authored in Golang using the [blueprint-test framework](https://pkg.go.dev/github.com/GoogleCloudPlatform/cloud-foundation-toolkit/infra/blueprint-test#section-readme) and
