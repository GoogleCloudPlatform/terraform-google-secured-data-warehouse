...
1. You need to create network and subnetwork in the landing zone project [configured for Private Google Access](https://cloud.google.com/vpc/docs/configure-private-google-access).
...
| confidential\_subnets\_self\_link | The URI of the subnetwork where Landing Zone Dataflow is going to be deployed. | `string` | n/a | yes |
...
| landing\_zone\_subnets\_self\_link | The URI of the subnetwork where Landing Zone Dataflow is going to be deployed. | `string` | n/a | yes |
